...
if __name__=='__main__':
    ...
    if len(sys.argv)==2 and sys.argv[1]=='-h':
        ...
        if len(sys.argv)==4:
            ...
            #                      'L': cf.COND_TEST12,
            #                       'P': cf.COND_PROD}
            condition_dic_full = {'TA': cf.COND_TEST_PRH1,
                                  'TB': cf.COND_TEST_PRH2,
                                  'TC': cf.COND_TEST_PRH3,
                                  'TD': cf.COND_TEST_PRH4,
                                  'TE': cf.COND_TEST_PRH5,
                                  'TF': cf.COND_TEST_PRH6,
                                  'TG': cf.COND_TEST_PRH7,
                                  'H': cf.COND_TEST8,
                                  'I': cf.COND_TEST9,
                                  'J': cf.COND_TEST10,
                                  'K': cf.COND_TEST11,
