...
def main(TIME_START, COND_LABEL):
    ...
    path_account = os.path.join('\\wsl$\Ubuntu-18.04\workspace\jazzstock_bot\simulation\result',TIME_START, COND_LABEL)
...
main(TIME_START = '20200829223257', COND_LABEL = 'TA')
